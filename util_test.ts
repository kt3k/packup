...
Deno.test("getDependencies - returns dependency specifiers", async () => {
  ...
  assertEquals(
    ...
    [
      ...
      "https://deno.land/std@0.149.0/_util/assert.ts",
      "https://deno.land/std@0.149.0/_util/os.ts",
      "https://deno.land/std@0.149.0/path/_constants.ts",
      "https://deno.land/std@0.149.0/path/_interface.ts",
      "https://deno.land/std@0.149.0/path/_util.ts",
      "https://deno.land/std@0.149.0/path/common.ts",
      "https://deno.land/std@0.149.0/path/glob.ts",
      "https://deno.land/std@0.149.0/path/mod.ts",
      "https://deno.land/std@0.149.0/path/posix.ts",
      "https://deno.land/std@0.149.0/path/separator.ts",
      "https://deno.land/std@0.149.0/path/win32.ts",
    ].map(normalize),
  );
});
